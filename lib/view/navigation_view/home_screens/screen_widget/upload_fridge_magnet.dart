...
class UploadFridgeMagnet extends StatefulWidget {
  final Function? onValue;
  const UploadFridgeMagnet({super.key, this.onValue});

  @override
  State<UploadFridgeMagnet> createState() => _UploadFridgeMagnetState();
}

class _UploadFridgeMagnetState extends State<UploadFridgeMagnet> {
  File? _image;
