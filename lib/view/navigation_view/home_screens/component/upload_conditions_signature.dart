...
class UploadConditionsSignature extends StatefulWidget {
  final Function onValue;

  const UploadConditionsSignature({super.key, required this.onValue});

  @override
  State<UploadConditionsSignature> createState() =>
      _UploadConditionsSignatureState();
}

class _UploadConditionsSignatureState extends State<UploadConditionsSignature> {
  File? _image;
            ...
            ? InkWell(
                ...
                child: Column(
                  children: [
                    ...
                    const CustomText(
                      data: 'Upload Terms & Conditions with Signature',
                      fSize: 14,
