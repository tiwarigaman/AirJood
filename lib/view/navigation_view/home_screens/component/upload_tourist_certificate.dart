...
class UploadTouristCertificate extends StatefulWidget {
  final Function onValue;
  const UploadTouristCertificate({super.key, required this.onValue});

  @override
  State<UploadTouristCertificate> createState() =>
      _UploadTouristCertificateState();
}

class _UploadTouristCertificateState extends State<UploadTouristCertificate> {
  File? _image;
            ...
            ? InkWell(
                ...
                child: Column(
                  children: [
                    ...
                    const CustomText(
                      data: 'Upload Tourist Certificate',
                      fSize: 14,
