...
//
//     final planningListModel = planningListModelFromJson(jsonString);

import 'dart:convert';

PlanningListModel planningListModelFromJson(String str) => PlanningListModel.fromJson(json.decode(str));

String planningListModelToJson(PlanningListModel data) => json.encode(data.toJson());
...
class PlanningListModel {
  ...
  factory PlanningListModel.fromJson(Map<String, dynamic> json) => PlanningListModel(
